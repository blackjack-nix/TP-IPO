...
public class Cercle
{
    ...
    public Cercle(int D , int X , int Y , String c){
        //this();
        this.aDiametre=D;
        this.aXPosition=X;
        this.aYPosition=Y;
        this.changeCouleur(c);
        this.rendVisible();
    }
    ...
    {
        int vPosition = 1000 * this.aXPosition + this.aYPosition;
        return vPosition;
    }
} // Cercle
